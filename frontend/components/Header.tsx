          ...
          {loading ? (
            ...
            <>
              ...
              <button
                type="button"
                onClick={() => logout()}
                className="hidden sm:inline-block text-sm font-medium text-muted hover:text-brandGreen transition-colors"
              >
                Logout
              </button>
            </>
            ...
            <>
              ...
              <Link
                href="/register"
                className="hidden sm:inline-block text-sm font-medium text-brandGreen hover:underline"
              >
                Sign Up
              </Link>
            </>
